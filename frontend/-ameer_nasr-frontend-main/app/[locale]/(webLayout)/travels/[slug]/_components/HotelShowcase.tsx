...
// 1 hero + 2x2 thumbnails (last = Video Gallery), matching the Things
// to Do / Tours detail pages.
const images = [
  { id: 1, src: "/resort2.png", alt: "Bali villa hero" },
  { id: 2, src: "/resort4.jpg", alt: "Ubud rice terraces" },
  { id: 3, src: "/resort2.png", alt: "Seminyak beachfront" },
  { id: 4, src: "/resort4.jpg", alt: "Spa pavilion" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const PACKAGE_TITLE = "BALI WELLNESS RETREAT - 10 NIGHTS PACKAGE";
      ...
      <div className="bg-[#f2f4f7] py-3 border-b border-gray-100">
        <Container>
          <div className="flex items-center gap-2 text-xs md:text-sm text-gray-500 font-medium flex-wrap">
            ...
            <ChevronRight size={14} className="text-gray-300" />
            <span className="text-gray-400 uppercase">{PACKAGE_TITLE}</span>
          </div>
        </Container>
      </div>
    </section>
