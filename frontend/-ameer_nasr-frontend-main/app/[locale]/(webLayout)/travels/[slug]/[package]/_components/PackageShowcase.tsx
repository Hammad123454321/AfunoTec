...
const images = [
  { id: 1, src: "/resort2.png", alt: "South Africa landscape" },
  { id: 2, src: "/resort4.jpg", alt: "Cape Town view" },
  { id: 3, src: "/resort2.png", alt: "Kruger game drive" },
  { id: 4, src: "/resort4.jpg", alt: "Game lodge" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const PACKAGE_TITLE = "SOUTH AFRICA SAFARI - 9 NIGHTS PACKAGE";
