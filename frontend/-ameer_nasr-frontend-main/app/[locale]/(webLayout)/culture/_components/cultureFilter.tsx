...
export default function TransportationFilterSidebar() {
  ...
  const mealPlanfilter = {
    ...
    label: "Meal Plans",
    options: [
      { value: "all-inclusive", label: "All Inclusive", count: 4 },
  { value: "full-board", label: "Full-Board", count: 34 },
  { value: "breakfast-dinner", label: "Breakfast & Dinner", count: 24 },
  { value: "bed-breakfast", label: "Bed & Breakfast", count: 84 },
  { value: "snacks-drinks", label: "Snacks & drinks", count: 84 },
  { value: "lunch-only", label: "Lunch only", count: 84 },
    ],
  };
...
{/* meal plan Filter */}
        <div className="border-b border-gray-200">
          ...
          {expandedSections["transportation"] && (
            <div className="px-4 pb-4 space-y-2">
              {mealPlanfilter.options.map((option) => (
                <label
                  key={option.value}
                  className="flex items-center cursor-pointer group"
                >
