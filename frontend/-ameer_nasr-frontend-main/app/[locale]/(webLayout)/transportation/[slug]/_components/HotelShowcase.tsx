...
// Video Gallery — same pattern as the hotel / activity / tour detail
// pages.
const images = [
  { id: 1, src: "/resort2.png", alt: "Private sedan exterior" },
  { id: 2, src: "/resort4.jpg", alt: "Spacious interior" },
  { id: 3, src: "/resort2.png", alt: "Luggage capacity" },
  { id: 4, src: "/resort4.jpg", alt: "Driver waiting at airport" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const SERVICE_TITLE =
  "ANTANANARIVO AIRPORT - PRIVATE SEDAN TRANSFER";
      ...
      <div className="bg-[#f2f4f7] py-3 border-b border-gray-100">
        <Container>
          <div className="flex items-center gap-2 text-xs md:text-sm text-gray-500 font-medium flex-wrap">
            ...
            <ChevronRight size={14} className="text-gray-300" />
            <span className="text-gray-400 uppercase">{SERVICE_TITLE}</span>
          </div>
        </Container>
      </div>
    </section>
