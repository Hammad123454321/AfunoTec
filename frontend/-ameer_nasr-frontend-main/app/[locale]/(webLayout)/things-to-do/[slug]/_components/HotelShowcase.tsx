...
// Five-image gallery matching the Figma: one large hero on the left,
// 2x2 thumbnails on the right with the bottom-right tile carrying the
// Video Gallery overlay.
const images = [
  { id: 1, src: "/resort2.png", alt: "Île des Deux Cocos hero" },
  { id: 2, src: "/resort4.jpg", alt: "Beach view" },
  { id: 3, src: "/resort2.png", alt: "Pool area" },
  { id: 4, src: "/resort4.jpg", alt: "Statue area" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const ACTIVITY_TITLE = "LUXURY DAY AT ILE DES DEUX COCOS ISLAND";
      ...
      <div className="bg-[#f2f4f7] py-3 border-b border-gray-100">
        <Container>
          <div className="flex items-center gap-2 text-xs md:text-sm text-gray-500 font-medium flex-wrap">
            ...
            <ChevronRight size={14} className="text-gray-300" />
            <span className="text-gray-400 uppercase">{ACTIVITY_TITLE}</span>
          </div>
        </Container>
      </div>
    </section>
