...
const images = [
  { id: 1, src: "/resort2.png", alt: "Andilana Beach Resort hero" },
  { id: 2, src: "/resort4.jpg", alt: "Beach view" },
  { id: 3, src: "/resort2.png", alt: "Pool area" },
  { id: 4, src: "/resort4.jpg", alt: "Suite interior" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const HOTEL_TITLE = "ANDILANA BEACH RESORT NOSY BE - ALL INCLUSIVE";
