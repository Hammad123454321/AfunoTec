...
export default function StaysFilterSidebarMobile() {
  ...
  const keyFeaturesFilter: Filter = {
    id: "key-features",
    label: "Key Features",
    options: [
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-50 bg-black bg-opacity-50 pb-16" onClick={toggleMenu}>
