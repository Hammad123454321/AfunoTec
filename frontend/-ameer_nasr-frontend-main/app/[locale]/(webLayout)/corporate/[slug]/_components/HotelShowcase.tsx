...
const images = [
  { id: 1, src: "/resort2.png", alt: "Sunset Beats and Bites hero" },
  { id: 2, src: "/resort4.jpg", alt: "Beach venue" },
  { id: 3, src: "/resort2.png", alt: "BBQ stations" },
  { id: 4, src: "/resort4.jpg", alt: "DJ booth and dance area" },
  { id: 5, src: "/resort2.png", alt: "Video Gallery", isVideo: true },
];

const EVENT_TITLE = "SUNSET BEATS AND BITES - TEAM BUILDING BEACH PARTY";
